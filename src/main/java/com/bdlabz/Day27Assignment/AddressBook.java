...
public class  AddressBook {
    ...
    HashMap<String,ArrayList<Contact>> contactsByCity = new HashMap<String,ArrayList<Contact>>();
    HashMap<String,ArrayList<Contact>> contactsByState = new HashMap<String,ArrayList<Contact>>();
    ...
    public void addContact() {
        ...
        if(contactsByState.containsKey(contactPerson.getState())){
            ...
            list.add(contactPerson);
            contactsByState.put(contactPerson.getState(), new ArrayList<Contact>(list));
        }
    }
        ...
        for (Contact contactPerson : contactList) {
            if (name.equals(contactPerson.getName())) {
                ...
                if(contactsByState.containsKey(contactPerson.getState())){      // to remove the person from  contactByState map
                    ArrayList<Contact> contacts = contactsByState.get(contactPerson.getState());
                    contacts = new ArrayList<>(contacts.stream().filter(x-> x.getName() != contactPerson.getName()).collect(Collectors.toList()));
    ...
    public void sortByName(){
        ...
        contactList = new ArrayList<>(contactList.stream().sorted((person1,person2)-> person1.getName().compareTo(person2.getName())).collect(Collectors.toList()));
    }

    public void sortByZip(){

        contactList = new ArrayList<>(contactList.stream().sorted((person1,person2)-> person1.getZipCode().compareTo(person2.getZipCode())).collect(Collectors.toList()));
    }

    public void sortByCity(){

        contactList = new ArrayList<>(contactList.stream().sorted((person1,person2)-> person1.getCity().compareTo(person2.getCity())).collect(Collectors.toList()));
    }

    public void sortByState(){

        contactList = new ArrayList<>(contactList.stream().sorted((person1,person2)-> person1.getState().compareTo(person2.getState())).collect(Collectors.toList()));
    }
